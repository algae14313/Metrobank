...
const chartData = [
    { work: "hr", visitors: 275, fill: "var(--color-hr)" },
    { work: "it", visitors: 200, fill: "var(--color-it)" },
    { work: "rb", visitors: 287, fill: "var(--color-rb)" },
    { work: "other", visitors: 190, fill: "var(--color-other)" },
];
