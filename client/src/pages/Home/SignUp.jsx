                ...
                <div className="w-full h-full flex justify-end items-center">
                    <div className="w-[30%] h-full flex justify-center items-center">
                        <form className='w-full h-full flex flex-col justify-center items-center gap-[1rem] px-[4rem]'>
                            ...
                            <button onClick={handleSignUp} className='w-full py-[.6rem] rounded-lg text-[#FFFFFF] hover:bg-[#111111] hover:text-white duration-300 ease bg-[#001A88] shadow-[_0_10px_15px_-3px_rgba(0,0,0,0.1)]'>
                                Sign Up
                            </button>
