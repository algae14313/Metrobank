...
import '../../index.css'; // Make sure this import points to where your CSS file is located
                ...
                <div className="w-full h-full flex justify-start items-center">
                    ...
                    <div className="w-[30%] h-full flex justify-center items-center">
                        <form
                            ...
                            <button type='submit' className='w-full py-[.6rem] rounded-lg text-[#FFFFFF] hover:bg-[#111111] hover:text-white duration-300 ease bg-[#001A88] shadow-[_0_10px_15px_-3px_rgba(0,0,0,0.1)]'>
                                Login
                            </button>
